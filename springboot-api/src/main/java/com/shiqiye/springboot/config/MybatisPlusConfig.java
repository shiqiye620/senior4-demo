...
@Configuration
@MapperScan("com.shiqiye.springboot.mapper")
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
        ...
        String moduleName = "springboot-api";
//        String moduleName = "";
        // 代码生成器
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/senior4?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
//        pc.setModuleName(scanner("请输入你的包名"));
        //需要修改
        pc.setParent("com.shiqiye.springboot");//你哪个父目录下创建包
...
//        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        //需要修改
        strategy.setInclude("t_user","t_area","t_classes","t_hobby","t_student","t_sudent_hobby_relation");
